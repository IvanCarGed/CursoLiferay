...
public class DatabaseService {
	...
	public static void init() {
		...
		{
			Web web = new Web ("google", "https://www.google.es", "Buscador predeterminado");
			insert(web);
		}
		{
			Web web = new Web ("youtube", "https://www.youtube.es", "Pagina para ver videos");
			insert(web);
		}
		{
			Web web = new Web ("marca", "https://www.marca.com", "Publicacion deportiva");
			insert(web);
		}
